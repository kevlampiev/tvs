...
class AlterProcedureagreementSettlementsByToday2 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared('
                    DROP PROCEDURE IF EXISTS agreement_settlements_by_today;
        ');


        $sql = <<<SQL
CREATE PROCEDURE agreement_settlements_by_today(IN days_forward int)
BEGIN
...
where (a.real_date_close is null) or (a.real_date_close > current_date())
