...
class CreateGuaranteeLegalEntitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('guarantee_legal_entities', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('guarantor_id')->on('companies')->references('id');
    ...
    {
        Schema::dropIfExists('guarantee_legal_entities');
    }
}
