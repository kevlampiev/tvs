...
class AlterGreatSearchView extends Migration
{
    /**
     * Run the migrations.
     *
...
UNION
SELECT an.agreement_id,
	'agreement_none' entity_type,
	an.note_body entity_text ,
	null closed_at
FROM agreement_notes an
UNION
SELECT ce.counterparty_id,
	'employee' entity_type,
	CONCAT(IFNULL(ce.name,''),' ',IFNULL(ce.title,' '), ' ', IFNULL(ce.description,'')) entity_text ,
	null closed_at
FROM counterparty_employees ce
