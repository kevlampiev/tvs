            ...
            <div class="row">
                <div class="col-md6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" aria-describedby="veh-name" placeholder="Введите название оборудования" name="name"
                               value="{{$vehicle->name}}">
                    </div>

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="vin">Заводской номер/VIN</span>
                        <input type="text" class="form-control" aria-describedby="vin" placeholder="Введите заводской номер/VIN" name="vin"
                               value="{{$vehicle->vin}}">
                    </div>

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="bort_number">Бортовой номер</span>
                        <input type="text" class="form-control" aria-describedby="bort_number" placeholder="Введите бортовой номер/ номер госрегистрации" name="bort_number"
                               value="{{$vehicle->bort_number}}">
                    </div>

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="prod_year">Год выпуска</span>
                        <input type="number" class="form-control" aria-describedby="bort_number" placeholder="2021" name="prod_year"
                               value="{{$vehicle->prod_year}}">
                    </div>

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="trademark">Торговая марка</span>
                        <input type="text" class="form-control" aria-describedby="trademark" placeholder="Введите название торговой марки" name="trademark"
                               value="{{$vehicle->trademark}}">
                    </div>

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="model">Модель</span>
                        <input type="text" class="form-control" aria-describedby="model" placeholder="Введите название модели" name="model"
                               value="{{$vehicle->model}}">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" class="form-control" aria-describedby="market_price" placeholder="Введите название модели" name="market_price"
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="date" class="form-control" aria-describedby="model" placeholder="Введите дату приобретения" name="estimate_date"
